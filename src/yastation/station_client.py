# Vendored from https://github.com/yasg1988/yandex-station-mcp
# (which itself borrows the Quasar/Glagol approach of AlexxIT/YandexStation, MIT).
# Copied as-is into this project so `uv sync` doesn't depend on that repo
# having a proper package layout. Only the imports below were touched.
